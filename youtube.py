...
def yt_search(search_query):
    params = {
        ...
        'q': search_query,
        'type': 'video',
        'key': 'AIzaSyCUv1jqvlnaaJr2RI1vb2ApnwHyNE5g7Lc',
        'maxResults': 5,
...
def download_video(url):
    try:
        ...
        return result.stdout.strip()  # Capture and return the output
...
def transcribe_file(path):
    ...
    print(f"Transcribing file at {path_to_transcribe}")
    ...
    print(f"Transcript saved to {path_to_transcribe}")
